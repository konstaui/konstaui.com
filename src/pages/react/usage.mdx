...
But if you use only Tailwind Mobile then we need to wrap all our components with Tailwind Mobile's **[App](/react/app)** component.

In **[App](/react/app)** component we can define global theme (iOS or Material) and other useful globals:
