...
const MyApp = () => {
  ...
  return (
    // Wrap Framework7's App with TailwindMobileProvider
...
<div className="important-note">
  <ul>
    <li>
      Make sure you pass the same <code>theme</code> to Framework7 and Tailwind
      Mobile.
    </li>
    <li>
      Material Design theme is called differenty in Framework7 and in Tailwind
      Mobile.
      <ul>
        <li>
          In Framework7 it is called <code>md</code>,
        </li>
        <li>
