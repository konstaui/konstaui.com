...
const App: React.FC = () => (
  // Wrap IonApp with TailwindMobileProvider
  <TailwindMobileProvider theme="material">
    <IonApp>
      <IonReactRouter>
        <IonRouterOutlet>
...
<div className="important-note">
  <ul>
    <li>
      Make sure you pass the same <code>theme</code> to Tailwind Mobile as
      Ionic's `mode`
    </li>
    <li>
      Material Design theme is called differenty in Ionic and in Tailwind
      Mobile.
      <ul>
        <li>
          In Ionic it is called <code>md</code>,
        </li>
        <li>
          In Tailwind Mobile it is called <code>material</code>
        </li>
      </ul>
    </li>
  </ul>
