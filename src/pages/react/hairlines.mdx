---
title: 'Hairlines | Konsta UI React'
section: 'react'
---
...
<div className="hairline-b relative">...</div>
```
...
<div className="hairline-b hairline-red-500 relative">...</div>
```
...
<div className="hairline-b hairline-red-500 hairline-duration-300 hover:hairline-blue-500 relative">
  ...
</div>
```
