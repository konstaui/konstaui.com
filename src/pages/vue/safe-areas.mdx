---
title: 'Safe Areas | Tailwind Mobile Vue'
section: 'vue'
---
...
If you use Tailwind Mobile's [App component](/vue/app), then it can be enabled with `safeAreas` prop:

```html
<!-- App.vue -->
<template>
  <!-- enable with safeAreas prop -->
  <twm-app safe-areas theme="ios">
    <HomePage />
  </twm-app>
</template>
<script>
